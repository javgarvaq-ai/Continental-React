-- ============================================================================
--  VERIFICACIÓN DE CONTEO — Continental POS
--  Generado: 2026-06-13  · Primeros 3 días de operación real
-- ----------------------------------------------------------------------------
--  CÓMO USARLO
--  1. Corre cada bloque por separado en el SQL Editor de Supabase.
--  2. En CADA bloque, ajusta las dos fechas en "params" (start_op / end_op).
--     Son DÍAS OPERATIVOS, no fechas de calendario (ver nota abajo).
...
-- ============================================================================
WITH params AS (SELECT date '2026-06-10' AS start_op, date '2026-06-13' AS end_op)
SELECT
    s.id,
    s.status,
